...
function obj_map(source, mapper) {
    ...
    var excludeProps = keysToObj(mapper.exclude);
    var includeProps = keysToObj(mapper.include);
    for (var key in source) {
        var val = source[key];
        if (val == null) {
            continue;
        ...
        var info = (_a = mapper.props) === null || _a === void 0 ? void 0 : _a[key];
        if ((_b = info) === null || _b === void 0 ? void 0 : _b.ignore) {
            continue;
        }
        var name = (_d = (_c = info) === null || _c === void 0 ? void 0 : _c.name, (_d !== null && _d !== void 0 ? _d : key));
        if ((_e = info) === null || _e === void 0 ? void 0 : _e.map) {
            out[name] = (_f = info) === null || _f === void 0 ? void 0 : _f.map(val);
            continue;
        }
