...
var StringEnum = /** @class */ (function (_super) {
    ...
    function StringEnum(prop, values) {
        var _this = _super.call(this, prop) || this;
        _this.values = values;
        return _this;
    }
...
(function (Rule) {
    ...
    function minimum(val) {
        return function (target, propertyKey, descriptor) {
            var rules = JsonUtils_1.JsonUtils.resolvePropertyRules(target, propertyKey);
            var rule = new Number_1.Minimum(propertyKey, val);
            rules.unshift(rule);
            return descriptor;
        };
    }
    ...
    function maximum(val) {
        return function (target, propertyKey, descriptor) {
            var rules = JsonUtils_1.JsonUtils.resolvePropertyRules(target, propertyKey);
            var rule = new Number_1.Maximum(propertyKey, val);
            rules.unshift(rule);
            return descriptor;
        };
    }
    ...
    function stringEnum(values) {
        return function (target, propertyKey, descriptor) {
            var rules = JsonUtils_1.JsonUtils.resolvePropertyRules(target, propertyKey);
            var rule = new String_1.StringEnum(propertyKey, values);
            rules.unshift(rule);
            return descriptor;
        };
    }
    ...
    function getSchema(Type, schema) {
        ...
        if (((_b = meta) === null || _b === void 0 ? void 0 : _b.properties) != null) {
            for (var prop in meta.properties) {
                ...
                if (propMeta.rules) {
                    for (var _i = 0, _d = propMeta.rules; _i < _d.length; _i++) {
                        var rule = _d[_i];
